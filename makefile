...
_DEPS = aircraft.h airport.h flight_rules.h json.h radio_message.h radio.h runway.h threadable.h

# Lista de arquivos intermediários de compilação gerados pelo projeto
# (arquivos .o).

_OBJ = main.o aircraft.o airport.o json.o radio.o runway.o

# Lista de arquivos fontes utilizados para compilação.

_SRC = main.cpp aircraft.cpp airport.cpp json.cpp radio.cpp runway.cpp
